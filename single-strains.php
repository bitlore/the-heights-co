...
<div class="content">
		    ...
		    <?php if (have_posts()) : while (have_posts()) : the_post();
			 ...
			 ?>
		    	...
		    	<section class="single-strain section-padding text-center">
						...
						<ul class="accordion small-12 cell" data-accordion data-allow-all-closed="true">
						  <li class="accordion-item" data-accordion-item>
						    ...
						    <div class="accordion-content grid-x" data-tab-content style="display: none;" data-equalizer data-equalize-on="medium">
								...
								<?php } ?>
								<ul data-equalizer-watch class="details low-level small-12 medium-5 cell">
							  ...
							  <div data-equalizer-watch class="action-items small-12 medium-2 cell">
