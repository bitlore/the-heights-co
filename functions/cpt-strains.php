<?php
/* joints Custom Post Type Strains
...
function cpt_strains() {
	...
	register_post_type( 'strains', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
	 	// let's now add all the options for this post type
		array('labels' => array(
			'name' => __('Strains', 'jointswp'), /* This is the Title of the Group */
			'singular_name' => __('Strain', 'jointswp'), /* This is the individual type */
			'all_items' => __('All Strains', 'jointswp'), /* the all items menu item */
			'add_new' => __('Add New', 'jointswp'), /* The add new menu item */
			'add_new_item' => __('Add New Strain', 'jointswp'), /* Add New Display Title */
			'edit' => __( 'Edit', 'jointswp' ), /* Edit Dialog */
			'edit_item' => __('Edit Strain', 'jointswp'), /* Edit Display Title */
			'new_item' => __('New Strain', 'jointswp'), /* New Display Title */
			'view_item' => __('View Strain', 'jointswp'), /* View Display Title */
			'search_items' => __('Search Strains', 'jointswp'), /* Search Custom Type Title */
			'not_found' =>  __('Nothing found in the Database.', 'jointswp'), /* This displays if there are no entries yet */
			'not_found_in_trash' => __('Nothing found in Trash', 'jointswp'), /* This displays if there is nothing in the trash */
			'parent_item_colon' => ''
			), /* end of arrays */
			'description' => __( 'This is the strains custom post type', 'jointswp' ), /* Custom Type Description */
			'public' => true,
	...
	register_taxonomy_for_object_type('category', 'strains');
	/* this adds your post tags to your custom post type */
	/* register_taxonomy_for_object_type('post_tag', 'strains'); */

}

	// adding the function to the Wordpress init
	add_action( 'init', 'cpt_strains');
	...
	*/
    ...
    // 	array('strains'), /* if you change the name of register_post_type( 'strains', then you have to change this */
